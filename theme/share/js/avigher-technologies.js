(function ($) {
    ...
    var services = {
            ...
            facebook: {
                ...
                supportCount: true,
                screenSize: { height: 306, width: 650 }
            },
            googleplus: {
                url: 'https://plus.google.com/share?url={url}',
                supportCount: true,
                screenSize: { height: 620, width: 620 }
            },
            linkedin: {
            ...
            pocket: {
                ...
                supportCount: false,
                screenSize: { height: 360, width: 576 }
            },
            reddit: {
            ...
            stumbleupon: {
                ...
                supportCount: true,
                screenSize: { height: 602, width: 480 }
            },
            tumblr: {
            ...
            twitter: {
                ...
                supportCount: true,
                screenSize: { height: 420, width: 550 }
            },
            vkontakte: {
                url: 'https://vk.com/share.php?url={url}',
                supportCount: true,
                screenSize: { height: 445, width: 642 }
            }
        },
        locales = {
            'en_US': {
                ...
                alias: ['en', 'en-US'],
                messages: {
                    buffer: { title: 'Share on Buffer' },
                    delicious: { title: 'Share on Delicious' },
                    digg: { title: 'Share on Digg' },
    ...
    function popup(elem) {
        ...
        var w = window.open(fmt(service.url, { url: url, title: title, description: description, image: image }),
                            'sharegg',
                            fmt('width={width}, height={height}, resizable=1, scrollbars=1, top=0, left=0', service.screenSize));
    ...
    function loadCount(elem) {
        ...
        if (elem) {
            buttons = elem.find('div.social-btn');
        } else {
            buttons = $('div.social-btn');
        }
    ...
    function createShareButtons(elem, opt) {
        ...
        $.each(opt.buttons, function (item) {
            if (this.show === true) {
                ...
                elem.append('<div class="social-btn fade"> \
                                 <a href="javascript:void(0);" \
                                    onclick="sharegg.popup(this);" \
                                    data-service-name="' + serviceName + '" \
                                    title="' + title + '"> \
                                    <i class="social-btn ' + serviceName + '-btn"></i> \
                                 </a> \
                             </div>');
    ...
    $.fn.sharegg = function () {
        ...
        return this.each(function () {
            ...
            e.addClass('sharegg-widget').append('<div class="social-container"><div class="social-buttons"></div></div>');
            ...
            createShareButtons(e.find('.social-buttons'), opt);
            loadCount(e);
        });
    };
