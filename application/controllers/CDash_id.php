...
class CDash_id extends CI_Controller
{
  public function index()
  {
    ...
    if ($row->status == "1") {
      ...
      $this->load->view("id/participant/dashboard/verifikasi/verifikasi", $get);
    ...
    if ($row->status == "2") {
      ...
      $this->load->view("component/id/header", $title);
      $this->load->view("component/id/navbar");
      $this->load->view("id/participant/dashboard/verifikasi/waiting", $get);
    ...
    if ($row->status == "4") {
      ...
      $this->load->view("component/id/header", $title);
      $this->load->view("component/id/navbar");
      $this->load->view("id/participant/dashboard/index", $get);
      $this->load->view("component/id/footer_log");
    }
    if ($row->status == "5") {
      $title["title"] = "Waiting Verified | Sarana Crowdfunding";
      $this->load->view("component/id/header", $title);
      $this->load->view("component/id/navbar");
      $this->load->view("id/participant/dashboard/verifikasi/banned", $get);
      $this->load->view("component/id/footer_log");
    }
    if ($row->status == "3") {
      $title["title"] = "Waiting Verified | Sarana Crowdfunding";
      $this->load->view("component/id/header", $title);
      $this->load->view("component/id/navbar");
      $this->load->view("id/participant/dashboard/verifikasi/danied", $get);
      $this->load->view("component/id/footer_log");
    }
  }
  ...
  function dashboard()
  {
    ...
    $this->load->view("component/id/header", $title);
    $this->load->view("component/id/navbar");
    $this->load->view("id/participant/dashboard/dashboard", $get);
    $this->load->view("component/id/footer_log");
  }
  ...
  function verifikasi()
  {
    ...
    $this->form_validation->set_rules(
      "nik",
      "NIK",
      "trim|required|numeric|callback_nik_check"
    );
  ...
  {
    $cekk = $this->db
      ->query("SELECT * FROM cfs_participant where nik='" . $strr . "'")
      ->num_rows();
    if ($cekk > 0) {
      $this->form_validation->set_message(
        "nik_check",
        '<span style="color:red">* NIK sudah terpakai</span>'
      );
      return false;
    } else {
      return true;
  ...
  function create_campaign()
  {
    ...
    $this->load->view("component/id/navbar");
    $this->load->view(
      "id/participant/dashboard/campaign/create-campaign",
      $get
    );
    $this->load->view("component/id/footer_form");
  }
  ...
  function new_campaign()
  {
    ...
    $this->load->view("component/id/header", $title);
    $this->load->view("component/id/navbar");
    $this->load->view("id/participant/dashboard/campaign/new-campaign", $get);
    $this->load->view("component/id/footer_form");
  }
