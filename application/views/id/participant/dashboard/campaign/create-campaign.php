            ...
            <div class="content-wrapper d-flex align-items-center ">
                ...
                <div class="col-lg-8 mx-auto">
                    ...
                    <div class="auto-form-wrapper" id="ccampaign">
                        ...
                        <form id="formcampaign" method="post" enctype="multipart/form-data" action="<?= base_url() . 'cdash_id/input_campaign' ?>">
                            ...
                            <div class="tab">
                                    ...
                                    <div class="input-group mb-3">
                                        <select class="custom-select custom-select-sm">
                                            ...
                                            <?php foreach ($category as $opt) : ?>
                                                <option class="py-4" value="<?= $opt->id ?>"><?= $opt->category_title ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="input-group mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="target" id="ribuan" class="form-control">
                                    </div>

                                </div>
                                <div class="mb-3">
                                    <label for="formFile" class="form-label">Banner Campaign</label>
                                    <input type="file" class="form-control" name="banner" style="padding-top: 0.5rem;" />
                                </div>
                            </div>
                            <div class="tab">
                                <div class="form-group">
